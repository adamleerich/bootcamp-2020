...
library(tidyverse)
source('ratemaking-capstone/resources.R')
...
claims <- read_csv(
  "ratemaking-capstone/claims.csv")

pol_dates <- read_csv(
  "ratemaking-capstone/pol_dates.csv")
...
state_lookup <- read_csv(
  'ratemaking-capstone/states.csv')
...
save(
  pol_final, claims_final, 
  file = 'ratemaking-capstone/reshaped_data.Rdata')
