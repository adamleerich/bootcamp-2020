...
The `geom_*` functions clarify how the data should be rendered. 
...
How do I know which parameters do what? Help, google and stack overflow are your friends. 
...
* `ggplot2` may be difficult at first, but will repay your investment.
